...
class ObserverSpeciesWeekly(models.Model):
    class Meta:
        db_table = "observer_species_weekly"
        verbose_name = _("ObserverSpeciesWeekly")
        verbose_name_plural = _("ObserverSpeciesWeekly")
        managed = False
    ...
    observer = models.ForeignKey(
        "data.Observer",
        related_name="observer_species_weekly",
    ...
    week = models.IntegerField(
        db_index=True,
        verbose_name=_("week"),
        help_text=_("The week the observation was made."),
    )
