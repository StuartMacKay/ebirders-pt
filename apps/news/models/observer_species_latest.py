...
class ObserverSpeciesLatest(models.Model):
    class Meta:
        db_table = "observer_species_latest"
        verbose_name = _("ObserverSpeciesLatest")
        verbose_name_plural = _("ObserverSpeciesLatest")
        managed = False
    ...
    observer = models.ForeignKey(
        "data.Observer",
        related_name="observer_species_latest",
