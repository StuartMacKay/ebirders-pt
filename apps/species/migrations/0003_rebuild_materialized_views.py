...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('species', '0002_materialized_views'),
    ]

    operations = [
        migrations.RunSQL(
            sql="DROP MATERIALIZED VIEW IF EXISTS country_list"
        ),
        migrations.RunSQL(
        ...
        migrations.RunSQL(
            sql="DROP MATERIALIZED VIEW IF EXISTS state_list"
        ),
        migrations.RunSQL(
        ...
        migrations.RunSQL(
            sql="DROP MATERIALIZED VIEW IF EXISTS county_list"
        ),
        migrations.RunSQL(
